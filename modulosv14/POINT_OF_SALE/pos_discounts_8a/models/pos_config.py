...
class PosConfig(models.Model):
    ...
    pos_discounts_8a_category_id = fields.Many2one('pos.category','Catagoria Grupo Descuento')
    allow_discounts_8a = fields.Boolean('Permitir Descuentos por Grupo')
    ...
    # discount_date_product_id = fields.Many2one('product.product', string='Garantia Product',
    #     domain="[('sale_ok', '=', True)]", help='The product used to model the discount.')
    #
    # @api.onchange('company_id','module_pos_discount')
    # def _default_discount_date_product_id(self):
    ...
    #
    # @api.model
    # def _default_discount_date_value_on_module_install(self):
    ...
    #         conf._default_discount_date_product_id()
