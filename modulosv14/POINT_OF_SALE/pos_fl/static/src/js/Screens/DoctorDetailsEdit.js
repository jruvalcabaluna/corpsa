odoo.define('pos_fl.DoctorDetailsEdit', function(require) {
    'use strict';
    ...
    class DoctorDetailsEdit extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        saveChanges() {
            ...
            if ((!this.props.partner.name && !processedChanges.name) ||
                ...
                return this.showPopup('ErrorPopup', {
                  title: _t('El Nombre del Doctor es Requerido!'),
                });
            }

            if ((!this.props.partner.barcode && !processedChanges.barcode) ||
                processedChanges.barcode === '' ){
                return this.showPopup('ErrorPopup', {
                  title: _t('La Cedula del Doctor es Requerida!'),
                });
            }
    ...
    DoctorDetailsEdit.template = 'DoctorDetailsEdit';

    Registries.Component.add(DoctorDetailsEdit);
