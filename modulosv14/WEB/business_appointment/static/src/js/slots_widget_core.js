...
//          REPLACE TO AVIOD TRANSFORM NEW DATE W WRONG TZ / FORCE + 00:00:00
            var resDate = new Date(target_date + ' 00:00:00');
            var res = target_date;
            if (date_format == "year") {res = resDate.getFullYear();}
            else if (date_format == "month") {res = moment.monthsShort()[resDate.getMonth()];}
//            else if (date_format == "weekday") {res = moment.weekdaysShort()[resDate.getDay()];}
//          REPLACE TO SHOW NAME OF WEEKDAY AVOID INSTEAD SHORTNAME
            else if (date_format == "weekday") {res = moment.weekdays()[resDate.getDay()];}
            return res
        },
        /**
