...
class business_resource(models.Model):
    ...
    def action_construct_time_slots(self, resource_type_id, service_id, duration, date_start, date_end,
        ...
        intervals_dict = resource_ids._retrieve_resource_intervals(start_dt=date_start, end_dt=date_end,)
    ...
    def _retrieve_resource_intervals(self, start_dt=None, end_dt=None):
        """
