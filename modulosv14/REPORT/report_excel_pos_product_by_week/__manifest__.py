...
{
    'name': 'POS Product Sales by Week Report (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'POS Product Sales by Week Report (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
POS Product Sales by Week Report.
====================================
POS Product Sales by Week Report in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/pos_product_sales_by_week.xml',
    ],
    'qweb': [
    ],
    'demo': [],
