                          ...
                          $("<li></li>")
                              ...
                              .append(
                                  $("<div></div>")
                                      ...
                                      .addClass(["seatCharts-seat", "seatCharts-cell", item[1]].concat(settings.classes, typeof settings.seats[item[0]] == "undefined" ? [] : settings.seats[item[0]].classes).join(" "))
                              )
                              .append($("<span></span>").addClass("seatCharts-legendDescription").text(item[2]))
                      );
                  });
