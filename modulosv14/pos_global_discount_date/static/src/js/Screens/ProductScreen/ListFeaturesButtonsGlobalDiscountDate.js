odoo.define('pos_global_discount_date.ListFeaturesButtonsGlobalDiscountDate', function (require) {
    ...
    const ListFeaturesButtons = require('pos_retail.ListFeaturesButtons');
//    const PosComponent = require('point_of_sale.PosComponent');
    ...
    class ListFeaturesButtonsGlobalDiscountDate extends ListFeaturesButtons {
//    class ListFeaturesButtonsGlobalDiscountDate extends PosComponent {
        ...
        async setGlobalDiscountDate() {
            ...
            if (selectedOrder.is_return) {
                return this.showPopup('ErrorPopup', {
                    title: this.env._t('Error'),
                    body: this.env._t('It not possible add Global Discount for Order Return')
                })
            }
            ...
            if (confirmed) {
                selectedOrder.add_global_discount_date(selectedItems.items[0]['item'])
            }
        }
    }
...
//
//    Registries.Component.add(ListFeaturesButtonsGlobalDiscountDate);
//
