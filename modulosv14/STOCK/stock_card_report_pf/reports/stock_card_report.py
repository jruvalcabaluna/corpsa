...
class StockCardReport(models.TransientModel):
    ...
    def print_report_global(self, report_type="qweb"):
        self.ensure_one()
        action = (
            report_type == "xlsx"
            and self.env.ref("stock_card_report_pf.action_stock_card_report_xlsx")
            or self.env.ref("stock_card_report_pf.action_stock_card_report_pdf_global")
        )
    ...
    def print_report(self, report_type="qweb"):
        ...
        action = (
            report_type == "xlsx"
            and self.env.ref("stock_card_report_pf.action_stock_card_report_xlsx")
            or self.env.ref("stock_card_report_pf.action_stock_card_report_pdf")
        )
        return action.report_action(self, config=False)
    ...
    def _get_html(self):
        ...
        if report:
            ...
            result["html"] = self.env.ref(
                "stock_card_report_pf.report_stock_card_report_html"
            )._render(rcontext)
        return result
