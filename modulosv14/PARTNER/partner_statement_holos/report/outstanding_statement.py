...
class OutstandingStatement(models.AbstractModel):
    ...
    _name = "report.partner_statement_holos.outstanding_statement_holos"
    _description = "Partner Outstanding Statement Holos"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if "company_id" not in data:
            wiz = self.env["outstanding.statement.holos.wizard"].with_context(
