...
class StockQuantQueue(models.Model):
    ...
    product_id = fields.Many2one('product.product', 'Product Variant', readonly=1, ondelete='cascade')
    quant_id = fields.Integer('Quant ID', required=1, readonly=1, ondelete='cascade')
