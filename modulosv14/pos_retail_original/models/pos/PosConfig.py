...
class PosConfig(models.Model):
    ...
    big_datas_turbo = fields.Boolean(
        ...
        help='If checked, any modifiers need update to POS \n'
             'Required close POS Sessions and open back for update new modifiers'
    )
    ...
    three_color = fields.Char('Three of App', default='#555555')
    cart_box_style = fields.Selection([
        ('left', 'Left of Page'),
        ('right', 'Right of Page')
    ], default='right', required=1)
    ...
    payment_screen_background = fields.Char('Payment Screen Background', default='#eaeaea')
    ...
    def revertToDefaultStyle(self):
        self.write({
            ...
            'three_color': '#555555',
            'payment_screen_background': '#eaeaea',
