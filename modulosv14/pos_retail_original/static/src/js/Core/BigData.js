odoo.define('pos_retail.big_data', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        async sync_products_partners() {
            console.log('[sync_products_partners] started !!!')
            if (this.startingSync) {
                console.log('[sync_products_partners] stop because have 1 request sync before !!!')
                return true
            }
            ...
            console.log('[sync_products_partners] successfully')
            return total
        },
    ...
    db.include({
        ...
        set_last_write_date_by_model: function (model, results) {
            ...
            console.log('[set_last_write_date_by_model] last write_date of model :  ' + model + ' is : ' + this.write_date_by_model[model])
            console.log('[set_last_write_date_by_model] last write_date of model :  ' + model + ' with id : ' + this.product_max_id)
        },
    ...
    models.load_models([
        ...
        },
        {
            ...
            domain: function (self) {
                let domain = ['|', ['config_id', '=', self.config.id], ['state', '=', 'draft']];
                if (self.config.pos_orders_load_orders_another_pos) {
                    domain = []
                }
                let today = new Date();
            ...
            domain: function (self) {
                let domain = ['|', ['pos_config_id', '=', self.config.id], ['pos_config_id', '=', null]];
